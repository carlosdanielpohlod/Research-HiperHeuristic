...
def hiperHeuristica_Aleatoria(fluxo, distancias, tamInstancia, numExecucoes, instancia, multiplicador = 20):
    ...
    for i in range(numExecucoes): 
        ...
        for j in range(tamInstancia * multiplicador):
            # codHeuristicas.codReproducao,codHeuristicas.codBuscaLocal, codHeuristicas.codMutacao = heuristicaEscolha.escolher(excluir = [[2,1,1], [2,2,1], [2,2,2], [2,2,3], [2,3,3]])
            codHeuristicas.codReproducao,codHeuristicas.codBuscaLocal, codHeuristicas.codMutacao = heuristicaEscolha.escolher(excluir = [[1,1,1], [1,1,3], [1,2,1], [1,2,2], [1,3,1], [2,1,1], [2,1,3], [2,2,1], [2,2,2], [2,2,3], [2,3,1], [2,3,2], [2,3,3]]) #excluir esses    
